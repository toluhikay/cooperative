import { _commodity_data } from "../../../lib/utils/Data"
...
export default function CommodityTradingStatement(){
    return <>
    ...
    <div class="py-3 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
      <div
        ...
        >
    <Table render_body={renderTable_body(_commodity_data)} render_head={renderTable_head(_commodity_data)}/>
