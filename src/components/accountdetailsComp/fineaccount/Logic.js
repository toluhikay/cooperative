import { _fine_account } from "../../../lib/utils/Data"
...
export default function FineAccount(){
    return <>
    ...
    <div class="py-3 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
      <div
        ...
        >
    <Table render_body={renderTable_body(_fine_account)} render_head={renderTable_head(_fine_account)}/>
