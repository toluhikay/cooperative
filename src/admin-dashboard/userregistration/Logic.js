...
export default function MemberRegistration() {
	...
	const select_style =
		"form-select appearance-none block w-full px-3 py-3 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none";
			...
			async (res) => {
				...
				if (status) {
					...
					if (status.status === "success") {
						...
						navigate("/admin-dashboard/registered-member");
					} else {
	...
	return (
		<MemberRegistration_update name="Register Member">
			<form onSubmit={formik.handleSubmit}>
				...
				<div className="grid grid-cols-2 gap-x-4 ">
					{/* <Input
							...
							error={formik.errors.loanStatus}
							touched={formik.touched.loanStatus}
							input_style={input_style}
						/> */}
					...
					{/* <Input
							...
							error={formik.errors.membershipStatus}
							touched={formik.touched.membershipStatus}
							input_style={input_style}
						/> */}
				</div>
